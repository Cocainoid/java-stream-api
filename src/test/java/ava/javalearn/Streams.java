package ava.javalearn;

import ava.javalearn.domain.Department;
import ava.javalearn.domain.Employee;
import ava.javalearn.domain.Event;
import ava.javalearn.domain.Position;
...
//        Stream<Path> walk = Files.walk(Paths.get("./"), 3);
        ...
        Stream<Integer> iterate = Stream.iterate(1950, integer -> integer + 3);

        Stream<String> concat = Stream.concat(stringStream, builder);
    }
...
//        emps.stream().forEachOrdered(employee -> System.out.println(employee.getAge()));
        ...
        IntStream intStream = IntStream.of(10, 200, 300, 500);
        intStream.reduce((left, right) -> left + right).orElse(0);

        System.out.println(deps.stream().reduce(this::reducer));

        IntStream.of(10, 200, 300, 500).average();
        IntStream.of(10, 200, 300, 500).max();
        IntStream.of(10, 200, 300, 500).min();
        IntStream.of(10, 200, 300, 500).sum();
        IntStream.of(10, 200, 300, 500).summaryStatistics();
    ...
    public void transform() {
        ...
        IntStream.of(10, 200, 300, 500).distinct();
